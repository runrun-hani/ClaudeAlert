...
public partial class SettingsWindow : Window
{
    ...
    private void LoadSettings()
    {
        ...
        ShowStatusBarCheck.IsChecked = _settings.ShowStatusBar;
    ...
    private void RefreshLabels()
    {
        ...
        ShowStatusBarCheck.Content = L10n.Get("settings.show_status_bar");
    ...
    private void OnSaveClick(object sender, RoutedEventArgs e)
    {
        ...
        _settings.ShowStatusBar = ShowStatusBarCheck.IsChecked == true;
